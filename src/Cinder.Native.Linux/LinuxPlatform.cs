...
namespace Cinder.Native.Linux;

/// <summary>
/// Linux <see cref="IPlatform"/>. Phase 0 stub — concrete imaging, snapshot enumeration, and
/// dm-readonly wrapping land in Phase 2.
/// </summary>
...
public sealed class LinuxPlatform : IPlatform
{
    ...
    public string SecureCredentialStoreId => "libsecret";

    public IRawDevice OpenDevice(string identifier) =>
        throw new NotImplementedException("Linux raw-device IO arrives in Phase 2.");
